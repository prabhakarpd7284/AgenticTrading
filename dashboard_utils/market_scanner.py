...
# ── Extended universe — NIFTY Next 50 + popular mid-caps ──
...
SECTOR_MAP = {
    "IT": ["TCS", "INFY", "HCLTECH", "WIPRO", "TECHM", "ETERNAL", "NAUKRI", "OFSS"],
    "Banking": ["HDFCBANK", "ICICIBANK", "SBIN", "KOTAKBANK", "AXISBANK", "INDUSINDBK",
                 "BANKBARODA", "CANBK", "PNB", "FEDERALBNK", "IDFCFIRSTB"],
    "Finance": ["BAJFINANCE", "BAJAJFINSV", "SBILIFE", "HDFCLIFE", "SHRIRAMFIN",
                 "CHOLAFIN", "ICICIPRULI", "SBICARD", "JIOFIN", "LICI", "PFC", "RECLTD", "MFSL"],
    "Auto": ["MARUTI", "M&M", "BAJAJ-AUTO", "EICHERMOT", "HEROMOTOCO", "TVSMOTOR", "MOTHERSON"],
    "Pharma": ["SUNPHARMA", "CIPLA", "DRREDDY", "DIVISLAB", "APOLLOHOSP", "LUPIN", "MAXHEALTH", "TORNTPHARM"],
    "Metal": ["TATASTEEL", "JSWSTEEL", "HINDALCO", "JINDALSTEL", "VEDL"],
    "Energy": ["RELIANCE", "NTPC", "POWERGRID", "ONGC", "BPCL", "COALINDIA", "ADANIENT", "ADANIPORTS",
               "ADANIGREEN", "ADANIPOWER", "IOC", "NHPC"],
    "FMCG": ["HINDUNILVR", "ITC", "NESTLEIND", "BRITANNIA", "TATACONSUM", "COLPAL", "GODREJCP", "DMART"],
    "Infra": ["LT", "ULTRACEMCO", "GRASIM", "AMBUJACEM", "DLF", "ABB", "SIEMENS", "HAL", "BEL", "IRCTC"],
    "Telecom": ["BHARTIARTL"],
    "Others": ["TITAN", "ASIANPAINT", "TRENT", "PAGEIND", "PIIND", "PIDILITIND", "HAVELLS",
               "BERGEPAINT", "POLYCAB", "SRF", "BOSCHLTD", "INDHOTEL", "PAYTM", "TATAPOWER", "UNIONBANK"],
}
