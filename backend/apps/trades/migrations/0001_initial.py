# Generated by Django 5.1.15 on 2026-05-11 05:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('orders', '0001_initial'),
        ('portfolio', '0002_position_add_monthly_fields'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='options_positions', to='portfolio.portfolio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legs', to='trades.optionsposition')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='orders.order')),
