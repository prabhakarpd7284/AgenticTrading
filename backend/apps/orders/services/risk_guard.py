...
`apps.trades.services.risk_engine.RiskEngine` directly.
...
class DeterministicRiskGuard:
    """DEPRECATED. Use apps.trades.services.risk_engine.RiskEngine instead.
    ...
    def __init__(self, portfolio_provider: PortfolioProvider | None = None):
        warnings.warn(
            ...
            "use apps.trades.services.risk_engine.RiskEngine.",
