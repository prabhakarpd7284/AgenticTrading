...
from apps.portfolio.api.views_cockpits import (
    ...
    PostMortemView,
    RegimeHeatmapView,
    ResetTradingDataView,
    RiskBudgetView,
    SetCapitalView,
    SignalFunnelView,
    SizerSimulatorView,
    SlippageEdgeSetupsView,
    SlippageEdgeView,
    StructuralStopsView,
    ThetaForecastView,
)
...
urlpatterns = [
    ...
    path("slippage-edge/setups/", SlippageEdgeSetupsView.as_view(), name="slippage-edge-setups"),
    path("edge-ledger/", EdgeLedgerView.as_view(), name="edge-ledger"),
    path("intraday-rotation/", IntradayRotationView.as_view(), name="intraday-rotation"),
    path("earnings-overlay/", EarningsOverlayView.as_view(), name="earnings-overlay"),
    path("partial-fill/", PartialFillView.as_view(), name="partial-fill"),
    path("pyramid-triggers/", PyramidTriggersView.as_view(), name="pyramid-triggers"),
    path("cool-down/", CoolDownView.as_view(), name="cool-down"),
    path("reset/", ResetTradingDataView.as_view(), name="reset-trading-data"),
