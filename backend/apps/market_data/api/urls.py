...
urlpatterns = [
    ...
    path("news-shocks/pause/",   NewsShockPauseView.as_view(),   name="news-shocks-pause"),
    path("news-shocks/unpause/", NewsShockUnpauseView.as_view(), name="news-shocks-unpause"),
